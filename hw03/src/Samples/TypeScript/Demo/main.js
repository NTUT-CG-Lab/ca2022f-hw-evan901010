...
var temp="ParamAngleX";

document.getElementById("Sel").addEventListener('change', e=>{
  let cur = e.target.value;
  temp = cur;
  document.getElementById("SelectName").innerHTML = String(temp);
});


document.getElementById("numLowInput").addEventListener('input', e=>{
  document.getElementById("numLow").innerHTML = e.target.value;

  document.getElementById("ParamSelect").setAttribute("min", e.target.value);
});

document.getElementById("numHighInput").addEventListener('input', e=>{
  document.getElementById("numHigh").innerHTML = e.target.value;

  document.getElementById("ParamSelect").setAttribute("max", e.target.value);
});
